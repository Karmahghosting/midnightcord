...
VesktopLogger.log(`Midnightcord v${VesktopNative.app.getVersion()}`);

const { customEntries, customSections } = Vencord.Plugins.plugins.Settings as any as typeof SettingsPlugin;

customEntries.push({
    key: "Midnightcord_Midnightcord_settings",
    title: "Midnightcord Settings",
    Component: SettingsUi,
    Icon: VesktopSettingsIcon
});

customSections.push(() => ({
    section: "MidnightcordSettings",
    label: "Midnightcord Settings",
    element: SettingsUi,
    className: "vc-Midnightcord-settings"
}));

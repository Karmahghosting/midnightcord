...
import {
    ...
    RestartIcon,
    Span
} from "@Midnightcord/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { onceReady } from "@Midnightcord/types/webpack";
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@Midnightcord/types/webpack/common";
...
const logger = new Logger("MidnightcordScreenShare");

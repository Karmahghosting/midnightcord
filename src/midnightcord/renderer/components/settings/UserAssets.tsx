...
import { BaseText, Button, FormSwitch } from "@Midnightcord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Midnightcord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`midnightcord://assets/${asset}?v=${version}`}
                    alt=""

...
import { Button, Card, HeadingTertiary, Paragraph } from "@Midnightcord/types/components";
import { useAwaiter } from "@Midnightcord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Midnightcord is outdated!</HeadingTertiary>

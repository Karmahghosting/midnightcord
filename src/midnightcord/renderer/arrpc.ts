...
import { Logger } from "@Midnightcord/types/utils";
import { findLazy, onceReady } from "@Midnightcord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Midnightcord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("MidnightcordRPC", "#5865f2");

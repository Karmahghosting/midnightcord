...
export const PORTABLE =
    ...
    !existsSync(join(MidnightcordDir, "Uninstall Midnightcord.exe"));

export const DATA_DIR =
    process.env.Midnightcord_USER_DATA_DIR || (PORTABLE ? join(MidnightcordDir, "Data") : join(app.getPath("userData")));

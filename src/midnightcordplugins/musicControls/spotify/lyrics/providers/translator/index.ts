...
import settings from "@midnightcordplugins/musicControls";
import { Provider, SyncedLyric } from "@midnightcordplugins/musicControls/spotify/lyrics/providers/types";

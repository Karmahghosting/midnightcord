...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@midnightcordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@midnightcordplugins/musicControls/spotify/SpotifyStore";

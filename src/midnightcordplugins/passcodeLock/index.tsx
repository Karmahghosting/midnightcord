...
// through the cracks: window.__midnightcordPCLReset()
...
export default definePlugin({
    ...
    authors: [{ name: "arg0NNY (ported by Midnightcord)",
     id: 0n }],
    settings,
    ...
    async start() {
        ...
        (window as any).__midnightcordPCLReset = () => forceReset("manually triggered via window.__midnightcordPCLReset()");
    ...
    stop() {
        ...
        clearTimeout(autolockTimeout);
        clearTimeout(watchdogTimeout);
        delete (window as any).__midnightcordPCLReset;

            ...
            for (const acc of rawAccounts) {
                ...
                if (tok.startsWith("dQw4w9WgXcQ:")) {
                    try {
                        ...
                        console.error("[Midnightcord] decyption failed for ", acc.username, e);
                    }
                }
...
export default definePlugin({
    ...
    start() {
        addHeaderBarButton("midnightcord-token-importer", () => <TokenImporterButton />, 10);
        getAccounts().then(async existing => {
            try {
    ...
    stop() {
        removeHeaderBarButton("midnightcord-token-importer");
        accountsCache = null;
    },
});
